...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout,
                             QSlider, QLabel, QPushButton, QFileDialog, QMessageBox, QGroupBox, QGridLayout, QDialog, QCheckBox, QScrollArea, QVBoxLayout, QDialogButtonBox)
...
class CellTrajectoryPlayer(QMainWindow):
    ...
    def load_tiff(self):
        ...
        if file_path:
            try:
                ...
                self.slider.setMaximum(len(self.tiff_stack) - 1)
    ...
    def load_csv(self):
        ...
        if file_path:
            try:
                self.cell_trajectories = self.parse_csv(file_path)
    ...
    def display_frame(self):
        ...
        frame_image = self.tiff_stack[self.current_frame]
